<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EduTestList.aspx.cs" Inherits="IncorruptEdu_EduTestList" %>
...
<body>
    <form runat="server">
        <section class="container">
            <div class="container-fluid">
                <fieldset>
                    <legend><small class="text-primary">我的在线考试</small></legend>
                    <!-- 查询条件 -->
                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table table-hover table-condensed table-bordered cursor">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="rpt_EduTestList" runat="server">
                                            <HeaderTemplate>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 5px;">
                                                        <a href='javascript:void(0);' onclick='showDetail("<%# Eval("EDU_T_GUID") %>")'>进入考试</a>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
    ...
    <script type="text/javascript">
        function showDetail(testid) {
            ...
            location.href = '/IncorruptEdu/TestOnline.aspx?test_id=' + testid + '&key=' + mytime;
        }
    </script>
</body>
</html>
