<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RiskDocument.aspx.cs" Inherits="Monitor_RiskDocument" %>
<!DOCTYPE html>
...
<body>
    ...
    <section class="container">
        <div class="container-fluid">
            <fieldset>
                <legend><small class="text-primary">风险项目--日常办公公文</small></legend>
                <!-- 查询条件（一） -->
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-hover table-condensed table-bordered cursor">
                                ...
                                <tbody id="tb_riskDocument"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            /***加载列表***/
            $.get("/Ajax/PublicQuery.ashx", { pageState: "riskDocument", username: $("#hiduserid").val(), pageSize: pageSize },
              function (data) {
                  ...
                  if (totalNum > 0) {
                      ...
                      $.each(obj, function (i) {
                          strTable += "<tr onclick='showDetail(" + obj[i].archive_id + "," + obj[i].archive_type + ");'><td>" + obj[i].rowno + "</td><td title='" + obj[i].archive_title + "'>" + obj[i].archive_title.substring(0, 10) + "</td><td>" + obj[i].type_name + "</td><td>" + obj[i].creator + "</td><td>" + obj[i].owner + "</td><td>" + obj[i].owner_dept + "</td><td>" + obj[i].start_time + "</td><td>" + obj[i].step_name + "</td><td>" + obj[i].limit_time + "</td><td title='" + obj[i].risk_point + "'>" + obj[i].risk_point.substring(0, 10) + "</td><td>" + obj[i].level_name + "</td></tr>";
                      });
                      $("#tb_riskDocument").html(strTable);
                      strTable = "";
                      pagination();//分页
                  }
                  else {
