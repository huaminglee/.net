<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selTempList.aspx.cs" Inherits="Archive_selTempList" %>
...
<body>
    <form id="tFrom" runat="server">
        <div class="temp">
                ...
                <table class="main_tempList" cellpadding="0px" cellspacing="0px">
                    ...
                    <asp:Repeater ID="rpt_tempList" runat="server" OnItemCommand="rpt_tempList_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lbtn_GetUser" Width="100%" Height="100%" runat="server" CommandName="GetUser" CommandArgument='<%# Eval("TEMPLATE_VALUE")%>' ForeColor="#4f9cd0"><%# Eval("TEMPLATE_JC")%></asp:LinkButton>
                                </td>
                                <td>
            ...
            <div class="temp_t"><span>人员信息</span></div>
            <div class="temp_list">
                <table class="main_tempList" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <th style="width:99%;">人员名称</th>
                    </tr>
                    <asp:Repeater ID="rpt_uList" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td>
                                   <asp:Label runat="server" ID="lblName" Text='<%# Eval("FULL_NAME")%>'></asp:Label> 
                                    <asp:HiddenField runat="server" ID="hidUserID" Value='<%# Eval("USER_ID") %>' />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
