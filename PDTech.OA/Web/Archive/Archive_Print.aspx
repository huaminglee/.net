<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Archive_Print.aspx.cs" Inherits="Archive_Archive_Print" %>
            ...
            <table width="640px" cellspacing="1" cellpadding="1" border="0px" bordercolor="#E3E3E3"
                ...
                <tr>
                    <td colspan="5" height="50px" class="microTitle">
                        <asp:Label runat="server" ID="lbTopTitle" Text="成都市水务局公文处理笺"></asp:Label>
                    </td>
                </tr>
            </table>
