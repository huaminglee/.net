<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewUnitDoc.aspx.cs" Inherits="Archive_NewUnitDoc" %>
                    ...
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center" border="0">
                        <tr>
                            ...
                            <td class="con_item_left">
                                <asp:DropDownList ID="dplDeptList" runat="server" CssClass="ddlinput input152">
                                </asp:DropDownList></td>
                            <td class="con_item" style="text-align: right;"><span>拟稿</span></td>
                            <td class="con_item_left">
                                <input type="text" id="txtUserName" runat="server" class="input input140" /></td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left">
                                <asp:TextBox ID="txtIs_net" runat="server" CssClass="input input152"></asp:TextBox>

                            <td class="con_item" style="text-align: right;"><span>是否作为规范性文件备案</span></td>
                            <td class="con_item_left">
                                <input type="text" id="txtIs_Spe" runat="server" class="input input140" /></td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left">
                                <asp:TextBox ID="txtPrintNum" runat="server" CssClass="input input152"></asp:TextBox>

                            <td class="con_item" style="text-align: right;"><span>校对</span></td>
                            <td class="con_item_left">
                                <input type="text" id="txtProo" runat="server" class="input input140" /></td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left">
                                <asp:TextBox ID="txtReview" runat="server" CssClass="input input152"></asp:TextBox>

                            <td class="con_item" style="text-align: right;"><span>份数</span></td>
                            <td class="con_item_left">
                                <input type="text" id="txtCopies" runat="server" class="input input140" /></td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left">
                                <asp:DropDownList ID="dplIsSecret" runat="server" CssClass="ddlinput input140">
                                </asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="1">
                                <asp:TextBox ID="txtDispath" runat="server" CssClass="input input152" MaxLength="15"></asp:TextBox>
                                <asp:Label runat="server" ID="lbDocNo" Text="号"></asp:Label></td>
                            <td class="con_item" style="text-align: right;">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <asp:TextBox ID="txtLordsent" runat="server" CssClass="input input664" MaxLength="1999"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="con_item" style="text-align: right;">
                                <span>抄送</span></td>
                            <td class="con_item_left" colspan="3">
                                <asp:TextBox ID="txtCc" runat="server" CssClass="inputArea664" MaxLength="1999" TextMode="MultiLine"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="con_item" style="text-align: right;">
                                <span>标题</span>
