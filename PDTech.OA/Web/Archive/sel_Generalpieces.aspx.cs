...
public partial class Archive_sel_Generalpieces : System.Web.UI.Page
{
    public string t_rand = "";
    public string arId = "";
    const decimal ARCHIVE_TYPE = 10;
    ...
    public void onBindData()
    {
        ...
        txtDispath.Text = ArDispath + Arwhere.ARCHIVE_NO + ArDocNo;
        txtRemark.Text = Arwhere.ARCHIVE_CONTENT;
        txtTitle.Text = Arwhere.ARCHIVE_TITLE;
        dplSzyd.Text = new ConvertHelper(Enum.Parse(typeof(EArchiveSzyd), (Arwhere.IS_SHOW_IN_SZYD ?? "0").ToString())).String;
        dplUrgency.Text = new ConvertHelper(Enum.Parse(typeof(EArchiveUrgency), (Arwhere.PRI_LEVEL ?? 0).ToString())).String;
        #endregion
