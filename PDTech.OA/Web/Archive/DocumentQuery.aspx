<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentQuery.aspx.cs" Inherits="Archive_DocumentQuery" %>
<!DOCTYPE html>
...
<body>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#deptList').combobox({
                url: '/Risk/UserControls/Ajax.aspx?queryState=mapDept',
            ...
            /***点击首页查询跳转至本页***/
            if (str != "" && str != null) {
                $.get("/Ajax/PublicQuery.ashx", { pageState: "documentQuery", txt_query: str, pageSize: pageSize },
                  function (data) {
            ...
            /***页面正常加载***/
                ...
                $.get("/Ajax/PublicQuery.ashx", { pageState: "documentQuery", pageSize: pageSize },
                  function (data) {
                      objTemp = $.parseJSON(data);//转换出总条数
                      totalNum = objTemp.TotalNum;//总条数
                      obj = $.parseJSON(objTemp.DataSources);//转换出数据源
