<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Com_UnitList.aspx.cs" Inherits="Archive_Com_UnitList" %>
...
<head runat="server">
    ...
    <link href="/CSS/popMain.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function openSelectFile() {
            ...
            window.parent.$("#txtSendUnit").val($("#hidTempId").val());
            ...
            <div class="con_c left">
                <table class="main_tabList" cellpadding="0px" cellspacing="0px">
                    <tr>
                        ...
                        <th style="width: 30%;">来文单位</th>
                        <th style="width: 50%;">单位简称</th>
                    </tr>
