<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selUnitDoc.aspx.cs" Inherits="Archive_selUnitDoc" %>
                ...
                <div class="con_b">
                    <table class="main_List" width="99%"  cellspacing="1" cellpadding="1" style="text-align: center" border="0">
                        <tr>
                            ...
                            <td class="con_item" style="text-align: right; width:25%;"><span>拟稿:</span></td>
                            <td class="con_item_left" style=" width:25%;">
