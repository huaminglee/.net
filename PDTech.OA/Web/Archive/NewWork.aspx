<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewWork.aspx.cs" Inherits="Archive_NewWork" %>
                    ...
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center" border="0">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <asp:TextBox ID="txtRemark" runat="server" MaxLength="999" TextMode="MultiLine" CssClass=" inputArea664"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
