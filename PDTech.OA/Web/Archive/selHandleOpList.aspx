<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selHandleOpList.aspx.cs" Inherits="Archive_selHandleOpList" %>
                ...
                <table class="main_tempList" cellpadding="0px" cellspacing="0px">
                    ...
                    <asp:Repeater ID="rpt_tempList" runat="server" OnItemCommand="rpt_tempList_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <asp:LinkButton ID="lbtn_GetUser" runat="server" CommandName="GetValue" CommandArgument='<%# Eval("TEMPLATE_VALUE")%>' ForeColor="#4f9cd0"><%# Eval("TEMPLATE_JC")%></asp:LinkButton>
                                </td>
                                <td>
