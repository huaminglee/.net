<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucSupList.ascx.cs" Inherits="Archive_UserControls_ucSupList" %>
...
<script>
    ...
    function NewArchive() {
        $.layer({
            type: 2,
            title: '新建公文',
            iframe: { src: '/Archive/newSupInfo.aspx?type=' + type + '' },
            maxmin: true,
            area: ['985px', '585px'],
    ...
    function doWork(tID, arId) {
        $.layer({
            type: 2,
            title: '办理公文',
            iframe: { src: '/Archive/newSupInfo.aspx?tId=' + tID + '&arId=' + arId + '&type=' + type + '' },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
    ...
    function selWork(tID, arId) {
        $.layer({
            type: 2,
            title: '查看公文',
            iframe: { src: '/Archive/selSupInfo.aspx?tId=' + tID + '&arId=' + arId + '&type=' + type + '' },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
