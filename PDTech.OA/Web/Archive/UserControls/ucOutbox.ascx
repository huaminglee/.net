<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucOutbox.ascx.cs" Inherits="Archive_UserControls_ucOutbox" %>
...
<section class="container">
    <div class="container-fluid">
        <fieldset>
            <legend><small class="text-primary">发信箱</small></legend>
            <!-- 查询条件 -->
            <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-1">
                    <input type="button" class="btn btn-primary" onclick="newMessage()" value="添&ensp;加" />
                </div>
            </div>
            <br />
            <!-- 数据展示 -->
                                ...
                                <Zore:Repeater ID="rpt_MsgList" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><a onclick='ShowReadState("<%# Eval("MESSAGE_ID")%>");'>接收状态</a></td>
                                        </tr>
                                    </ItemTemplate>
                                    <EmptyDataTemplate>
                                        <tr>
...
<script type="text/javascript">
    function newMessage() {
        $.layer({
            type: 2,
            title: '新建公告',
            iframe: { src: '/Archive/newMsgInfo.aspx' },
            maxmin: true,
            area: ['985px', '635px'],
