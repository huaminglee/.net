<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PiecesList.ascx.cs" Inherits="Archive_UserControls_PiecesList" %>
...
<section class="container">
    <div class="container-fluid">
        <fieldset>
            <legend><small class="text-primary">一般阅件</small></legend>
            <!-- 查询条件 -->
            <div class="row">
                <div class="col-sm-3">
...
<script>
    ...
    function NewArchive() {
        $.layer({
            type: 2,
            title: '新建公文',
            iframe: { src: '/Archive/newPieces.aspx' },
            maxmin: true,
            area: ['985px', '585px'],
    ...
    function doWork(tID, arId) {
        $.layer({
            type: 2,
            title: '公文办理',
            iframe: { src: '/Archive/newPieces.aspx?tId=' + tID + '&arId=' + arId },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
    ...
    function selWork(tID, arId) {
        $.layer({
            type: 2,
            title: '查看公文',
            iframe: { src: '/Archive/selPieces.aspx?tId=' + tID + '&arId=' + arId },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
