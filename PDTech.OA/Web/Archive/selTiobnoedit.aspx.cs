...
public partial class Archive_selTiobnoedit : System.Web.UI.Page
{
    ...
    public void onBindData()
    {
        ...
        lbtitle.Text = Arwhere.ARCHIVE_TITLE;
        if (Arwhere.ARCHIVE_TYPE != 71)
        {
            lbarchtype.Text = S_App.ShowTitle(Arwhere.ARCHIVE_TYPE.ToString());
        }
        else
        {
            lbarchtype.Text = Arwhere.ARCHIVE_NO;
        }
        
        lbcontent.Text = Arwhere.ARCHIVE_CONTENT;
