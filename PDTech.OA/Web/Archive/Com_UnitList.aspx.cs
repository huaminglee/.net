...
public partial class Archive_Com_UnitList : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        tList = sysBll.get_sysBase_DeptList(new PDTech.OA.Model.SYS_BASE_INFO() { BASE_NAME = txtName.Text.Trim(), SYS_TYPE = "来文单位" }, AspNetPager.CurrentPageIndex, AspNetPager.PageSize, out record);
