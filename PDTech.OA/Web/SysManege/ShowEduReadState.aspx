<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowEduReadState.aspx.cs" Inherits="SysManege_ShowEduReadState" %>
                            ...
                            <td class="con_item">
                                <table class="main_tabList">
                                    <asp:Repeater ID="rpt_UserList" runat="server">
                                        <HeaderTemplate>
                                            <tr>
                                                <th style="width: 40%;">接收人</th>
                                                <th style="width: 20%;">阅读次数</th>
                                                <th style="width: 40%;">首次阅读时间</th>
                                            </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr>
