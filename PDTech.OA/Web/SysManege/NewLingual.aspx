<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewLingual.aspx.cs" Inherits="SysManege_NewLingual" %>
        ...
        <div class="NewDept">
            <table class="Form_Main" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td>数据类型</td>
                    <td>
                        <asp:Label ID="lblSysType" runat="server" Text="文种"></asp:Label></td>
                    <td class="ImpTips">*</td>
                </tr>
                <tr>
                    <td>文种名称</td>
