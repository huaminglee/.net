<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucEduQuestionListsel.ascx.cs" Inherits="SysManege_UserControls_ucEduQuestionListsel" %>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a href='javascript:void(0);' onclick='selQuestion("<%# Eval("EDU_Q_GUID") %>")'>查看</a>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
...
<script>
    ...
    function selQuestion(quid) {
        $.layer({
            type: 2,
            title: '查看试题',
            iframe: { src: '/SysManege/selQuestion.aspx?qu_id=' + quid },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
