<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetRole_Purview.aspx.cs" Inherits="SysManege_SetRole_Purview" %>
...
<body>
    <form id="uFrom" runat="server">
        <div class="NewDept">
            <table class="Form_Main_CSS" cellpadding="0px" cellspacing="0px" style="height:80px;">
                <tr>
                    <td class="Form_Main_td" style="width:100px;">角色名称</td>
                    <td class="Form_Main_td">
                        <asp:Label ID="txtrName" runat="server"></asp:Label></td>
                </tr>
                <tr runat="server">
                    <td class="Form_Main_td">角色描述</td>
                    <td class="Form_Main_td">
