<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetUser_Purview.aspx.cs" Inherits="SysManege_SetUser_Purview" %>
    ...
    <form id="uFrom" runat="server">
        <div class="NewDept">
            <table class="Form_Main_CSS" cellpadding="0px" cellspacing="0px">
                ...
                <tr>
                    <td class="Form_Main_td">角色</td>
                    <td class="Form_Main_td" style="height: 120px;">
                        <div class="purTree_role">
                            <table class="Form_Main_user" cellpadding="0px" cellspacing="0px">
                                <asp:Repeater ID="rpt_RolrList" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <input type="checkbox" runat="server" id="chk_Id" value='<%# Eval("ROLE_ID") %>' /><%# Eval("ROLE_NAME") %>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
