<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DutyResponsibility.aspx.cs" Inherits="SysManege_DutyResponsibility" %>
<!DOCTYPE html>
        ...
        function showdropitem() {
            ...
            for (i = 0; i < el.length; i++) {
                ...
                for (j = 0; j < ddl.options.length; j++) {
                    ddl.options[j].title = ddl.options[j].text; //style="width:150px;height:35px;" class="easyui-combobox"
                }
            }
        }
    </script>
...
<body>
    <section class="container">
        <div class="container-fluid">
            <fieldset>
                <legend><small class="text-primary">岗位职责</small></legend>
                <div class="row">
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <label for="txt_responsibility" class="input-group-addon">岗位职责</label>
                            <input type="text" class="form-control" id="txt_responsibility">
                        </div>
                    </div>
                    <div class="col-sm-1">
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-hover table-condensed table-bordered cursor">
                                ...
                                <tbody id="tb_responsibility"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btn_query").click(function () {
                ...
                $.get("/Ajax/PublicQuery.ashx", {
                  ...
                  function (data) {
                      ...
                      if (totalNum > 0) {
                          $.each(obj, function (i) {
                              strTable += "<tr><td>" + obj[i].rowno + "</td><td>" + obj[i].department_name + "</td><td title='" + obj[i].duty_name + "'>" + obj[i].duty_name.substring(0, 15) + "</td><td title='" + obj[i].responsibility + "'>" + obj[i].responsibility.substring(0, 45) + "</td><td><span class='glyphicon glyphicon-remove text-danger' onclick='btnDelete(" + obj[i].duty_responsibility_id + ");'></span></td></tr>";
                          });
                      }
                      $("#tb_responsibility").html(strTable);
                      strTable = "";
                      pagination();//分页
                  });
            });
            ...
            $("#btn_add").click(function () {
                window.location.href = "AddDutyResponsibility.aspx";
            });
        ...
        /***删除***/
        function btnDelete(duty_responsibility_id) {
            id = duty_responsibility_id;
            $("#delete").modal("show");
        }
    </script>
</body>
