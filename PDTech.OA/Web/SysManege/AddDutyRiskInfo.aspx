<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddDutyRiskInfo.aspx.cs" Inherits="SysManege_AddDutyRiskInfo" %>
<!DOCTYPE html>
    ...
    <section class="container" style="width: 43%;">
        <fieldset>
            ...
            <form class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <label for="txt_gwzz" class="col-sm-2 control-label">岗位风险</label>
                    <div class="col-sm-10" style="white-space:nowrap;">
                        <textarea id="txt_dutyRisk" class="form-control" rows="3" maxlength="500"></textarea>
                        <span style="color:red;">*</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="radio">
                            <label>
                                <input type="radio" name="riskLevel" id="rbtn_one" value="1" checked>一级
                            </label>
                            <label>
                                <input type="radio" name="riskLevel" id="rbtn_two" value="2" />二级
                            </label>
                            <label>
                                <input type="radio" name="riskLevel" id="rbtn_three" value="3" />三级
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="txt_gwzz" class="col-sm-2 control-label">防范措施</label>
                    <div class="col-sm-10" style="white-space:nowrap;">
                        <textarea id="txt_avoidMetoh" class="form-control" rows="3" maxlength="2000"></textarea>
                        <span style="color:red;">*</span>
                    </div>
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btn_save").click(function () {
                if ($.trim($("#txt_riskName").val()) != "" && $.trim($("#txt_dutyRisk").val()) != "" && $.trim($("#txt_avoidMetoh").val()) != "" && $.trim($("#h_val").val()) != "") {
                    ...
                    $.post("/Ajax/PublicSave.ashx",
                        {
                            ...
                            txt_dutyRisk: $("#txt_dutyRisk").val(),
                            riskLevel: $("input[name='riskLevel']:checked").val(),
                            txt_avoidMetoh: $("#txt_avoidMetoh").val(),
                            h_val: $("#h_val").val()
                        },
                       function (data) {
            ...
            $("#btn_back").click(function () {
                window.location.href = "DutyRiskInfo.aspx";
            });
            ...
            $("#confirm").on("hidden.bs.modal", function (e) {
                $("#txt_riskName,#txt_dutyRisk,#txt_avoidMetoh,#txt_gwry,#h_val").val(null);
            });
        });
    </script>
</body>
