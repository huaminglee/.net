...
public partial class Admin_newConstImplement : System.Web.UI.Page
{
    ...
    public void InitBindData()
    {
        ...
        ///获取步骤审查意见附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> exList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "开工备案").ToList();
        ///获取步骤编制报告附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> plList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "进度管理").ToList();
        ///获取步骤专家评审结果附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> AccList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "重大设计变更审批").ToList();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            UpLoadFile(this.fileLoad, "开工备案");
            UpLoadFile(this.load_plait, "进度管理");
            UpLoadFile(this.loadacc, "重大设计变更审批");
            bool result = false;
            if (hidstate.Value == "0")
            {
