<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newFsr.aspx.cs" Inherits="Admin_newFsr" %>
    ...
    <form id="nForm" runat="server">
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目可行性研究报告表</h3>
                    <hr />
                </div>
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center;" border="0">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="fileArg" style="display: none;" onchange="ConfirmFile_Arg();" />
                                <input type="button" class="btn" id="btnArg" style="display:none" value="上传附件" onclick="UploadFile_Arg();" />
                            </td>
                        </tr>
                        <tr id="tr_ArgFile" style="display: none;">
                            <td class="auto-style5" style="text-align: right;"><span>涉水专项论证附件</span></td>
                            <td class="con_item_left" colspan="3">
                                <span id="ArgName"></span>
                            </td>
                        </tr>
                        <tr runat="server" id="tr_ArgList" visible="false">
                            ...
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    ...
                                    <asp:Repeater ID="rpt_ArgList" runat="server" OnItemDataBound="rpt_ArgList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                ...
                                <input type="button" class="btn" style="display:none" id="btnUpload" value="上传附件" onclick="UploadFile();" />
                            </td>
                        </tr>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                ...
                <asp:HiddenField runat="server" ID="hidArg" />
        ...
        <script type="text/javascript">
            ...
            function ConfirmFile_Arg() {
                var file = $('#fileArg').val();
                $("#ArgName").html(file);
                $("#hidArg").val("1");
                $("#tr_ArgFile").show();
            }
