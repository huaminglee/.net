...
/// 人事任免
/// </summary>
public partial class Admin_newPersonnel : System.Web.UI.Page
{
    ...
    PDTech.OA.BLL.WORKFLOW_STEP viewBll = new PDTech.OA.BLL.WORKFLOW_STEP();
    ...
    public string arId = "";
    PDTech.OA.Model.OA_ARCHIVE Arwhere = null;
    PDTech.OA.Model.OA_ARCHIVE_TASK tWhere;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (string.IsNullOrEmpty(contentTask_Id.ToString()) || contentTask_Id == 0)
            {
                ...
                if (!string.IsNullOrEmpty(txtLordsent.Text.Trim()))
                {
                    attList.Add(new PDTech.OA.Model.ATTRIBUTES() { KEY = "Lordsent", VALUE = new ConvertHelper(txtLordsent.Text.Trim()).String });
                }
                if (!string.IsNullOrEmpty(hidAttachmentIds.Value))
                {
                ...
                string state = ViewState["CuurStemp_State"].ToString();
