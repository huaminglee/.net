<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selFinance.aspx.cs" Inherits="Admin_selFinance" %>
<!DOCTYPE html>
    ...
    <form id="nForm" runat="server">
        ...
        <div class="main">
            <div class="content">
                ...
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center" border="0">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left">
                                <asp:DropDownList ID="dplFILE_DEPT" Enabled="false" runat="server" CssClass="ddlinput input140">
                                </asp:DropDownList></td>
                        </tr>
                        <tr>
                        ...
                        <tr style="display:none">
                            ...
                            <td class="con_item_left">
                                <input type="text" id="txtPlaneTime" runat="server" class="input input152" onfocus="WdatePicker({isShowClear:false,readOnly:true})" />
                            </td>
                ...
                <div class="con_oper">
                    <asp:Button ID="btnCc" runat="server" Text="抄送" style="display:none" CssClass="btn_Cc con_oper_btn let6" OnClick="btnCc_Click" />
        ...
        <script type="text/javascript">
            ...
            function ShowTheProcess() {
                var pId =<%=pId%>
                window.location.href = "Pro_Process.aspx?pId=" + pId;
            }
        </script>
    </form>
</body>
