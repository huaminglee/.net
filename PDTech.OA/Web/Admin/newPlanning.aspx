<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newPlanning.aspx.cs" Inherits="Admin_newPlanning" %>
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目规划表</h3>
                    <hr />
                </div>
                <div class="con_b">
                        ...
                        <tr style="display:none">
                         ...
                         <tr style="display:none">
                            ...
                            <asp:Label runat="server" ID="lblUserName"></asp:Label>    
                             ...
                             <td class="auto-style2" style=" width:90px; text-align: left;">
                                <span>审核时间</span></td>
