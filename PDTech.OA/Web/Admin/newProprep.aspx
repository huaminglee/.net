<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newProprep.aspx.cs" Inherits="Admin_newProprep" %>
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目生产准备表</h3>
                    <hr />
                </div>
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center;" border="0">
                        <tr>
                            ...
                            <td class="auto-style2" colspan="3">
                                <input type="text" runat="server" class="input Wdate input152" id="txtPlan_EndTIME" onfocus="WdatePicker({isShowClear:false,readOnly:true})" /></td>
                        </tr>
                        <tr>
                            <td class="auto-style5" style="text-align: right; width: 15%;">
                                <span>审核人</span></td>
