<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newDisbursementfunds.aspx.cs" Inherits="Admin_newDisbursementfunds" %>
    ...
    <form id="nForm" runat="server">
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目资金拨付表</h3>
                    <hr />
                </div>
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center;" border="0">
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="filePay" style="display: none;" onchange="ConfirmFile_Pay();" />
                                <input type="button" class="btn" id="btnbidPay" style="display:none" value="上传附件" onclick="UploadPay();" />
                            </td>
                        </tr>
                        <tr id="tr_Pay" style="display: none;">
                            <td class="auto-style5" style="text-align: right;"><span>付款申请附件</span></td>
                            <td class="con_item_left" colspan="3">
                                <span id="PayName"></span>
                            </td>
                        </tr>
                        <tr runat="server" id="tr_ShowPayList" visible="false">
                            ...
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    ...
                                    <asp:Repeater ID="rpt_PayList" runat="server" OnItemDataBound="rpt_PayList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="filePayr" style="display: none;" onchange="ConfirmFile_Payr();" />
                                <input type="button" class="btn" id="btnPayr" style="display:none" value="上传附件" onclick="UploadPayr();" />
                            </td>
                        </tr>
                        <tr id="tr_Payr" style="display: none;">
                            <td class="auto-style5" style="text-align: right;"><span>付款申请审核结果附件</span></td>
                            <td class="con_item_left" colspan="3">
                                <span id="PayrName"></span>
                            </td>
                        </tr>
                        <tr runat="server" id="tr_ShowPayrList" visible="false">
                            <td class="auto-style5"></td>
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    <tr>
                                    ...
                                    <asp:Repeater ID="rpt_PayrList" runat="server" OnItemDataBound="rpt_PayrList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <img src="../images/attachlogo.jpg" /><%# Eval("FILE_NAME") %></td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="fileMoney" style="display: none;" onchange="ConfirmFile_Money();" />
                                <input type="button" class="btn" id="btnsMoney" value="上传附件" style="display:none" onclick="UploadsMoney();" />
                            </td>
                        </tr>
                        ...
                        <tr runat="server" id="tr_ShowMoney" visible="false">
                            <td class="auto-style5"></td>
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    <tr>
                                    ...
                                    <asp:Repeater ID="rpt_MoneyList" runat="server" OnItemDataBound="rpt_MoneyList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <img src="../images/attachlogo.jpg" /><%# Eval("FILE_NAME") %></td>
                ...
                <div  class="con_oper">
                    <asp:Button ID="btnSubmit" style="display: none;" runat="server" Text="审核" CssClass="btn_submit con_oper_btn let6" OnClick="btnAudit_Click" />
                    <asp:Button ID="btnSave" style="display: none;" runat="server" Text="保存" CssClass="btn_save con_oper_btn let6" OnClick="btnSave_Click" />
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                ...
                <asp:HiddenField runat="server" ID="hidbidPay" />
                <asp:HiddenField runat="server" ID="hidPayr" />
        ...
        <script type="text/javascript">
            ...
            function ConfirmFile_Pay() {
                var file = $('#filePay').val();
                $("#PayName").html(file);
                $("#hidbidPay").val("1");
                $("#tr_Pay").show();
            }
            function ConfirmFile_Payr() {
                var file = $('#filePayr').val();
                $("#PayrName").html(file);
                $("#hidPayr").val("1");
                $("#tr_Payr").show();
            }
            function ConfirmFile_Money() {
                var file = $('#fileMoney').val();
                $("#MoneyName").html(file);
                $("#tr_Money").show();
            }
