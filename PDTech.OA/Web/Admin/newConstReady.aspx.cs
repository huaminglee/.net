...
public partial class Admin_newConstReady : System.Web.UI.Page
{
    ...
    public void InitBindData()
    {
        ...
        ///获取步骤审查意见附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> ArgList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "招标文件").ToList();
        ///获取步骤审查意见附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> exList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "开标监督文件").ToList();
        ///获取步骤编制报告附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> plList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "中标通知书").ToList();
        ///获取步骤专家评审结果附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> AccList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "合同").ToList();
        ...
        if (plList.Count > 0)
        {
            rpt_plaitList.DataSource = plList;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            UpLoadFile(this.fileArg, "招标文件");
            UpLoadFile(this.fileLoad, "开标监督文件");
            UpLoadFile(this.load_plait, "中标通知书");
            UpLoadFile(this.loadacc, "合同");
            bool result = false;
            if (hidstate.Value == "0")
            {
