<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newRecommendations.aspx.cs" Inherits="Admin_newRecommendations" %>
    ...
    <form id="nForm" runat="server">
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目项目建议书表</h3>
                    <hr />
                </div>
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center;" border="0">
                        ...
                        <tr id="trExamineFile" style="display: none;">
                         ...
                         <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                ...
                                <input type="button" class="btn" id="btnUpload_plait" style="display:none" value="上传附件" onclick="UploadFile_plait();" />
                            </td>
                        </tr>
                        <tr id="trPlaitFile" style="display: none;">
                         ...
                         <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                ...
                                <input type="button" class="btn" id="btnAcc" style="display:none" value="上传附件" onclick="UploadFile_Acc();" />
                            </td>
                        </tr>
                        ...
                        <tr style="display:none">
                            ...
                            <asp:Label runat="server" ID="lblUserName"></asp:Label>    
                             ...
                             <td class="auto-style2" style="text-align: left; width:90px;">
                                <span>审核时间</span></td>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                ...
                <asp:HiddenField runat="server" ID="hidUpload" />
