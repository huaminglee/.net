...
public partial class Admin_AddHandleOp : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        temp.TEMPLATE_JC =AidHelp.FilterSpecial(txtName.Text.Trim());
        temp.TEMPLATE_TYPE = "办理意见";
        temp.TEMPLATE_VALUE =AidHelp.FilterSpecial(txtValue.Text);
