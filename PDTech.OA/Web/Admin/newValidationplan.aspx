<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newValidationplan.aspx.cs" Inherits="Admin_newValidationplan" %>
...
<body onunload="FrameCloseAll();">
    <form id="nForm" runat="server">
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目审定计划表</h3>
                    <hr />
                </div>
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center;" border="0">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="fileProEva" style="display: none;" onchange="ConfirmFile_ProEva();" />
                                <input type="button" class="btn" id="btnProEva" style="display: none;" value="上传附件" onclick="UploadProEva();" />
                            </td>
                        </tr>
                        <tr id="trProEvaFile" style="display: none;">
                            <td class="auto-style5" style="text-align: right;"><span>申报项目评审附件</span></td>
                            <td class="con_item_left" colspan="3">
                                <span id="ProEvaname"></span>
                            </td>
                        </tr>
                        <tr runat="server" id="tr_showProEvaList" visible="false">
                            ...
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    ...
                                    <asp:Repeater ID="rpt_ProEvaList" runat="server" OnItemDataBound="rpt_ProEvaList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="fileProExet" style="display: none;" onchange="ConfirmFile_ProExet();" />
                                <input type="button" class="btn" id="btnProExet" style="display: none;" value="上传附件" onclick="UploadProExet();" />
                            </td>
                        </tr>
                        <tr id="tr_ProExet" style="display: none;">
                            <td class="auto-style5" style="text-align: right;"><span>申报项目签审附件</span></td>
                            <td class="con_item_left" colspan="3">
                                <span id="ProExetName"></span>
                            </td>
                        </tr>
                        <tr runat="server" id="trProExetList" visible="false">
                            <td class="auto-style5"></td>
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    <tr>
                                    ...
                                    <asp:Repeater ID="rpt_ProExetList" runat="server" OnItemDataBound="rpt_ProExetList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <img src="../images/attachlogo.jpg" /><%# Eval("FILE_NAME") %></td>
                ...
                <div class="con_oper" >
                    ...
                    <input type="button" id="btnPrevious" class="btn_back con_oper_btn let6" value="返回" onclick="backPrevious();" />
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                ...
                <asp:HiddenField runat="server" ID="hidProEva" />
                <asp:HiddenField runat="server" ID="hidProExet" />
 ...
 <asp:HiddenField ID="hidisedit" Value="0" runat="server" />
        ...
        <script type="text/javascript">
            ...
            function UploadProEva() {
                $("#fileProEva").click();
            }
            function UploadProExet() {
                if ($("#hidProEva").val() == "1") {
                    $("#fileProExet").click();
                }
                else {
            ...
            function ConfirmFile_ProEva() {
                var file = $('#fileProEva').val();
                $("#ProEvaname").html(file);
                $("#hidProEva").val("1");
                $("#trProEvaFile").show();
            }
            function ConfirmFile_ProExet() {
                var file = $('#fileProExet').val();
                $("#ProExetName").html(file);
                $("#hidProExet").val("1");
                $("#tr_ProExet").show();
            }
