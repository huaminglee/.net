<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newComAcpt.aspx.cs" Inherits="Admin_newComAcpt" %>
    ...
    <form id="nForm" runat="server">
                    ...
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center;" border="0">
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                ...
                                <input type="button" class="btn" id="btnApply" style="display:none" value="上传附件" onclick="UploadFile_Apply();" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                ...
                                <input type="button" class="btn" id="btnAccep" style="display:none" value="上传附件" onclick="UploadFile_Accep();" />
                            </td>
                        </tr>
                        ...
                        <tr style="display:none" runat="server" id="tr_showList" visible="false">
                            <td class="auto-style5"></td>
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    <tr>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                ...
                <asp:HiddenField runat="server" ID="hidAccep" />
