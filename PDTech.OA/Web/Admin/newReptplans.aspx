<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newReptplans.aspx.cs" Inherits="Admin_newReptplans" %>
...
<body onunload="FrameCloseAll();">
    <form id="nForm" runat="server">
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目上报计划表</h3>
                    <hr />
                </div>
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center;" border="0">
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="fileProBasis" style="display: none;" onchange="ConfirmFile_ProBasis();" />
                                <input type="button" class="btn" id="btnProBasis" style="display: none;" value="上传附件" onclick="UploadProBasis();" />
                            </td>
                        </tr>
                        <tr id="trProBasisFile" style="display: none;">
                            <td class="auto-style5" style="text-align: right;"><span>立项依据附件</span></td>
                            <td class="con_item_left" colspan="3">
                                <span id="ProBasisname"></span>
                            </td>
                        </tr>
                        <tr runat="server" id="tr_showProBasisList" visible="false">
                            ...
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    ...
                                    <asp:Repeater ID="rpt_ProBasisList" runat="server" OnItemDataBound="rpt_ProBasisList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <input type="file" runat="server" id="filefPlan" style="display: none;" onchange="ConfirmFile_fPlan();" />
                                <input type="button" class="btn" id="btnfPlan" style="display: none;" value="上传附件" onclick="UploadfPlan();" />
                            </td>
                        </tr>
                        <tr id="tr_fPlan" style="display: none;">
                            <td class="auto-style5" style="text-align: right;"><span>项目资金计划附件</span></td>
                            <td class="con_item_left" colspan="3">
                                <span id="fPlanName"></span>
                            </td>
                        </tr>
                        <tr runat="server" id="tr_fPlanList" visible="false">
                            <td class="auto-style5"></td>
                            <td class="con_item" colspan="3">
                                <table class="GridTitleCss">
                                    <tr>
                                    ...
                                    <asp:Repeater ID="rpt_fPlanList" runat="server" OnItemDataBound="rpt_fPlanList_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <img src="../images/attachlogo.jpg" /><%# Eval("FILE_NAME") %></td>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel">
            <ContentTemplate>
                ...
                <asp:HiddenField runat="server" ID="hidProBasis" />
 ...
 <asp:HiddenField ID="hidisedit" Value="0" runat="server" />
        ...
        <script type="text/javascript">
            ...
            function UploadProBasis() {
                $("#fileProBasis").click();
            }
            function UploadfPlan() {
                if ($("#hidProBasis").val() == "1") {
                    $("#filefPlan").click();
                }
                else {
            ...
            function ConfirmFile_ProBasis() {
                var file = $('#fileProBasis').val();
                $("#ProBasisname").html(file);
                $("#hidProBasis").val("1");
                $("#trProBasisFile").show();
            }
            function ConfirmFile_fPlan() {
                var file = $('#filefPlan').val();
                $("#fPlanName").html(file);
                $("#tr_fPlan").show();
            }
