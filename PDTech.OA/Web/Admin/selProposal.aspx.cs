...
public partial class Admin_selProposal : System.Web.UI.Page
{
    ...
    public void onBindData()
    {
        ...
        if (tWhere != null)
        {
            ...
            dplDateDocNo.Text = Arwhere.ARCHIVE_NO;
            txtRemark.Text = Arwhere.ARCHIVE_CONTENT;
            txtTitle.Text = Arwhere.ARCHIVE_TITLE;
            dplIsSecret.Text = Enum.Parse(typeof(EArchiveIsSecret), Arwhere.IS_SECRET.ToString()).ToString();
