<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newPreDesign.aspx.cs" Inherits="Admin_newPreDesign" %>
    ...
    <form id="nForm" runat="server">
        ...
        <div class="main">
            <div class="content">
                <div class="container-fluid text-center thisPadding">
                    ...
                    <h3 id="title" runat="server">水务项目初步设计或实施方案表</h3>
                    <hr />
                </div>
                <div class="con_b">
        ...
        <script type="text/javascript">
            ...
            function backPrevious() {
                var pId = $("#hidPId").val();
                window.location.href = '/Admin/Pro_Process.aspx?pId=' + pId + '&Isedit=' + $("#hidisedit").val();
            }
            function backPrevious() {
                var pId = $("#hidPId").val();
