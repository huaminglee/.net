<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newPersonnel.aspx.cs" Inherits="Admin_newPersonnel" %>
                    ...
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center" border="0">
                        <tr>
                            <td class="con_item" style="text-align: right;">
                                <span>是否“三重一大”</span></td>
                            <td class="con_item_left">
                                <asp:DropDownList runat="server" ID="dplSzyd" CssClass="ddlinput input140"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td class="con_item" style="text-align: right;">
                                <span>主送、抄送</span></td>
