<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucPersonnel.ascx.cs" Inherits="Admin_UserControls_ucPersonnel" %>
...
<section class="container">
    <div class="container-fluid">
        <fieldset>
            <legend><small class="text-primary">人事任免</small></legend>
            <!-- 查询条件 -->
            <div class="row">
                <div class="col-sm-3">
...
<script>
    ...
    function NewArchive() {
        $.layer({
            type: 2,
            title: '新建人事任免',
            iframe: { src: '/Admin/newPersonnel.aspx' },
            maxmin: true,
            area: ['985px', '585px'],
    ...
    function doWork(tID, arId) {
        $.layer({
            type: 2,
            title: '办理人事任免',
            iframe: { src: '/Admin/newPersonnel.aspx?tId=' + tID + '&arId=' + arId },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
    ...
    function selWork(tID, arId) {
        $.layer({
            type: 2,
            title: '查看人事任免',
            iframe: { src: '/Admin/selPersonnal.aspx?tId=' + tID + '&arId=' + arId },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
