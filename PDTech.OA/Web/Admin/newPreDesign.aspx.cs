...
public partial class Admin_newPreDesign : System.Web.UI.Page
{
    ...
    public void InitBindData()
    {
        ...
        ///获取步骤审查意见附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> exList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "定审结果").ToList();
        ///获取步骤编制报告附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> plList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "会签结果").ToList();
        ///获取步骤专家评审结果附件
        IList<PDTech.OA.Model.OA_ATTACHMENT_FILE> AccList = allList.Where(o => !string.IsNullOrEmpty(o.DATA1) && o.DATA1 == "领导签发").ToList();
