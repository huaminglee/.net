<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selProposal.aspx.cs" Inherits="Admin_selProposal" %>
        ...
        <asp:ScriptManager ID="ScriptManager" runat="server">
         ...
         <div class="main">
            <div class="content">
                ...
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center; width:100%;" border="0">
                        <tr>
                            <td class="con_item" style="text-align:right;width:15%;">
                                <span class="">紧急程度:</span>
                            </td>
                            <td class="con_item_left" style="width:35%;">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="1">
                                <asp:Label ID="dplDateDocNo" runat="server" >
                                </asp:Label>
                            </td>
                            <td class="con_item" style="text-align: right;">
                                <span>届别号数:</span></td>
                            <td class="con_item_left">
                                <asp:Label type="text" runat="server" id="txtPeriodNum"  ></asp:Label></td>
                        </tr>
                        <tr>
                            ...
                            <td class="con_item_left" colspan="1">
                                ...
                                <asp:Label type="text" runat="server" id="txtHeader" /></td>
                            <td class="con_item" style="text-align: right;">
                                <span>人数:</span></td>
                            <td class="con_item_left">
                                <asp:Label type="text" runat="server" id="txtUserNum" /></td>
                        </tr>
                         <tr>
                            <td class="con_item" style="text-align: right;">
                                <span>主送、抄送</span></td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <asp:Label ID="txtSummary" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="con_item" style="text-align:right;">
