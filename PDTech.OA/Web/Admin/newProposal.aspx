<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newProposal.aspx.cs" Inherits="Admin_newProposal" %>
                    ...
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center" border="0">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="1">
                                <asp:DropDownList ID="dplDateDocNo" runat="server" CssClass="ddlinput input152">
                                </asp:DropDownList>
                            </td>
                            <td class="con_item" style="text-align: right;">
                                <span>届别号数</span></td>
                            <td class="con_item_left">
                                <input type="text" runat="server" id="txtPeriodNum" class="input input140" /></td>
                        </tr>
                        <tr>
                            ...
                            <td class="con_item_left" colspan="1">
                                ...
                                <input type="text" runat="server" id="txtHeader" class="input input152" /></td>
                            <td class="con_item" style="text-align: right;">
                                <span>人数</span></td>
                            <td class="con_item_left">
                                <input type="text" runat="server" id="txtUserNum" class="input input140" /></td>
                        </tr>
                        <tr>
                            <td class="con_item" style="text-align: right;">
                                <span>主送、抄送</span></td>
                        ...
                        <tr>
                            ...
                            <td class="con_item_left" colspan="3">
                                <asp:TextBox ID="txtSummary" runat="server" TextMode="MultiLine" CssClass="inputArea664" MaxLength="999"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="con_item" style="text-align: right;">
