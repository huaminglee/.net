<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucRiskList.ascx.cs" Inherits="Risk_UserControls_ucRiskList" %>
...
<section class="container">
    <div class="container-fluid">
        <fieldset>
            <legend><small class="text-primary">风险处置单</small></legend>
            <!-- 查询条件 -->
            <div class="row">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <div class="input-group">
                        <label for="txtmName" class="input-group-addon">风险编号</label>
                        <asp:TextBox ID="txtArNum" runat="server" CssClass="form-control"></asp:TextBox>
                    </div>
                </div>
                <div class="col-sm-1">
                ...
                <div class="col-sm-1">
                    <input type="button" class="btn btn-primary" onclick="newRisk();" value="添&ensp;加" />
                </div>
            </div>
            <br />
            <!-- 数据展示 -->
...
<script type="text/javascript">
    ...
    function doWork(tID, arId) {
        $.layer({
            type: 2,
            title: '办理风险处置',
            iframe: { src: '/Risk/newRisk.aspx?tId=' + tID + '&arId=' + arId },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
