<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newArRisk.aspx.cs" Inherits="Risk_newArRisk" %>
                ...
                <div class="con_b">
                    <table class="main_List" cellspacing="1" cellpadding="1" style="text-align: center" border="0">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left">
                                <input type="text" id="txtHandleDate" runat="server" class="input input140" onfocus="WdatePicker({isShowClear:false,readOnly:true})" />
                                &nbsp;</td>
                        </tr>
                        <tr>

                            <td class="con_item" style="text-align: right;">
                                <span class="" runat="server" id="firstRisk"><a href="javascript:void(0);" onclick="showrUserList();">责任人</a></span>
                                <span class="" runat="server" id="editrisk">责任人</span>
                            </td>
                            <td class="con_item_left" colspan="1">
                        ...
                        <tr>
                            ...
                            <td class="con_item_left">
                                <asp:DropDownList ID="yearList" runat="server" CssClass="ddlinput ddlinput69">
                                </asp:DropDownList>
                                <input type="text" runat="server" id="txtSeqNum" class="input input140" />
                            </td>
                        </tr>
                        <tr>
                            <td class="con_item" style="text-align: right;">
        ...
        <script type="text/javascript">
            ...
            function showrUserList() {
                $.layer({
                    type: 2,
                    title: '选择人员',
                    iframe: { src: '/Risk/msgUserList.aspx' },
                    maxmin: true,
                    area: ['545px', '485px'],
            ...
            //设置接收人员
            function setreceiverUser(names) {
                $("#txtUserName").val(names);
                layer.closeAll();
            }
        </script>
    </form>
