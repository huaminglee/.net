<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Risk_Default" %>
        ...
        <div data-options="region:'west'" style="width: 150px;">
           <div id="leftMenu" class="easyui-accordion cursor" style="border: 1px">
                <div title="风险处置单管理" style="padding: 10px;">
                    <p onclick="MainFramCh('Main_Frame.aspx?action=ucRiskList')"><b><span class="glyphicon glyphicon-list-alt"></span>&emsp;风险处置&emsp;</b></p>
                    <p onclick="MainFramCh('ArRiskList.aspx')"><b><span class="glyphicon glyphicon-list-alt"></span>&emsp;监督督查&emsp;</b></p>
                </div>
            </div>
        </div>
        <!-- 右侧内容 -->
