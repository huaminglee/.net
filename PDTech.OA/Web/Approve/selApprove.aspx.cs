...
public partial class Approve_selApprove : System.Web.UI.Page
{
    ...
    {
        this.Page.ClientScript.RegisterStartupScript(GetType(), "showDiv", "<script>window.location.href='/Archive/RecipientList.aspx?tId=" + contentTask_Id + "&nId=99&action=copy'</script>");
    }
    /// <summary>
    /// 绑定下载地址
    /// </summary>
