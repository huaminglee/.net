<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Approve.ascx.cs" Inherits="Approve_UserControls_Approve" %>
...
<script>
    ...
    function NewArchive() {
        $.layer({
            type: 2,
            title: '新建公文',
            iframe: { src: '/Approve/newApprove.aspx?type=' + type + '' },
            maxmin: true,
            area: ['985px', '585px'],
    ...
    function doWork(tID, arId) {
        $.layer({
            type: 2,
            title: '办理公文',
            iframe: { src: '/Approve/newApprove.aspx?tId=' + tID + '&arId=' + arId + '&type=' + type + '' },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
    ...
    function selWork(tID, arId) {
        $.layer({
            type: 2,
            title: '查看公文',
            iframe: { src: '/Approve/selApprove.aspx?tId=' + tID + '&arId=' + arId + '&type=' + type + '' },
            maxmin: true,
            area: ['985px', '585px'],
            border: [1, 0.2, '#000', true],
            offset: ['20px', '']
