...
public partial class Approve_UserControls_Approve : System.Web.UI.UserControl
{
    ...
    public void BindData()
    {
        ...
        {
            case "41":
                lblTitle.InnerText = "排水许可";
                break;
            case "42":
                lblTitle.InnerText = "水土保持";
                break;
            case "43":
                lblTitle.InnerText = "涉水项目";
                break;
            case "44":
                lblTitle.InnerText = "用水计划";
                break;
            case "40":
                lblTitle.InnerText = "取水许可";
                break;
            case "61":
                lblTitle.InnerText = "财政预决算";
                break;
            case "62":
                lblTitle.InnerText = "三公经费";
                break;
        }
