<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newApprove.aspx.cs" Inherits="Approve_newApprove" %>
<!DOCTYPE html>
                        ...
                        <tr>
                         ...
                         <tr runat="server" id="tr_Mark" visible="false">
                            ...
                            <td class="con_item_left">
                                <asp:TextBox ID="txtRemark" runat="server" TextMode="MultiLine" CssClass=" inputArea664" MaxLength="1999"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
