...
namespace Maticsoft.DBUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static void ExecuteSqlTran(IList<sqlTrasExcuteComm> commandList)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                conn.Open();
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        SqlCommand cmd = new SqlCommand();
                        //循环
                        foreach (sqlTrasExcuteComm com in commandList)
                        {
                            string cmdText = com.commandText;
                            SqlParameter[] cmdParms = com.parameters;
        ...
        public static int ExecuteScalar(string strSQL, params SqlParameter[] cmdParms)
        {
            int result;
            try
            {
        ...
        private static void PrepareCommand(SqlCommand cmd, SqlConnection conn, SqlTransaction trans, string cmdText, SqlParameter[] cmdParms, CommandType cType)
        {
            if (conn.State != ConnectionState.Open)
                conn.Open();
            cmd.Connection = conn;
        ...
        public static void RunProcedure_Add(string storedProcName, SqlParameter[] parameters)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
    ...
    public class sqlTrasExcuteComm
    {
