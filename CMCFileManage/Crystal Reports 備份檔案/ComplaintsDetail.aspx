...
<body>
    ...
    <div>
        <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000"
            ...
            <tr id="cb1" runat ="server" visible="false" >
                <td>
                    調查結果
                </td>
                <td>
            ...
            <tr id ="cb2" runat ="server" visible="false">
                <td>
                    原因分析
                </td>
                <td>
            ...
            <tr id ="cb3" runat ="server" visible="false">
                <td>
                    改善對策
                </td>
                <td>
            ...
            <tr id ="cb4" runat ="server" visible="false">
                <td>
                    處理情況
                </td>
                <td>
            ...
            <tr id ="cb5" runat ="server" visible="false">
                <td>
                    核准
                </td>
                <td>
