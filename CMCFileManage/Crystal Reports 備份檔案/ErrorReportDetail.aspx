<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ErrorReportDetail.aspx.vb" Inherits="CMCFileManage.ErrorReportDetail" %>
        ...
        <table width="100%">
            <tr>
                <td width="33%">
                    ...
                    <asp:HiddenField ID="HidQulocation" runat ="server" /></td>
                <td width="33%">
    ...
    <div>
        ...
        <table  width="100%"  border="1" cellspacing="0" cellpadding="0"
            ...
            <tr>
                ...
                <td colspan="3"><asp:RadioButtonList ID="RDOAppsec" runat="server" 
                        RepeatDirection="Horizontal" RepeatLayout="Flow">
                        <asp:ListItem Value="1">主要缺失</asp:ListItem>
            ...
            <tr>
                <td colspan="4">
                    ...
                    <asp:TextBox ID="TxtFindOut" runat="server" Width="280px"></asp:TextBox>
            ...
            <tr>
                <td colspan="4">
                    根本原因和改正/預防措施<br />
                    <asp:TextBox ID="TxtReason" runat="server" Width="280px"></asp:TextBox>
            ...
            <tr>
                <td colspan="4">
                    驗證結果<asp:RadioButtonList ID="RDOVertifyResult" runat="server" 
                        RepeatDirection="Horizontal" RepeatLayout="Flow">
                    ...
                    <asp:TextBox ID="TxtResult" runat="server" Width="280px"></asp:TextBox>
