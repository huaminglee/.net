...
<head runat="server">
    ...
    <script src="../Forms/EquipManage.js" type="text/javascript"></script>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="實驗室">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="LbApplydept" runat="server" Text='<%#DataBinder.Eval(Container,"Dataitem.LabName") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Width="160px" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <uc1:GridQyext ID="GridQyext1" runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
