...
<head runat="server">
    ...
    <script src="../Forms/Ie6addbgiframe.js" type="text/javascript"></script>
...
<body>
    ...
    <table width="100%">
        <tr>
            <td>
                <asp:Image ID="Image4" runat="server" ImageUrl="../Images/blank.jpg" />
                <div>
                ...
                <div align="center">
                    <asp:Label ID="LbTitle" runat="server" Text="關鍵物品合格供應商" Font-Size="18px"></asp:Label>
                </div>
                <br />
                <div style="float: left; width: 60%">
                    <table style="height: 80px" border="1" cellspacing="0" cellpadding="0" bordercolor="#000000"
                        ...
                        <tr>
                            <td colspan="2" bgcolor="#E4F1FA" height="50">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TxtAssessCycle" Text="0" Width="250px" class="easyui-numberbox"
                                    data-options="min:0,max:1000,required:true,precision:0" runat="server"></asp:TextBox>個月
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div id="checkrecord" runat="server">
                    <table border="1" cellspacing="0" cellpadding="0" bordercolor="#000000" bordercolordark="#FFFFFF"
                        align="left" width="100%">
                        <tr>
                            <td class="LiAdd " bgcolor="#E4F1FA" colspan="2" height="50">
                                <table>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <a id="addcheck" runat="server" visible="false" href="#" onclick="addcheck()">添加檢查記錄</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
