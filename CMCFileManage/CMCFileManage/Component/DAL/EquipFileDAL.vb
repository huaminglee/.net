...
#Region " Method"
	#Region " Private method"
		...
		EquipFileInstance.eFlowDocID, _
		EquipFileInstance.IsFinish, _
		EquipFileInstance.StateOrder, _
		EquipFileInstance.StateName, _
        ...
        mInfo.EquipNum = IIf(dr.IsNull("EquipNum"), 0, dr.Item("EquipNum").ToString)
    ...
    End Function
    Public Shared Function GetEquipInfo() As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "GetEquipInfo")
        Dim dt As DataTable = ds.Tables(0)
        If (dt.Rows.Count = 0) Then
            Return Nothing
        End If
        Return dt
    End Function
    Public Shared Function GetEquipInfobySearchcondition(ByVal Searchcondition As String) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "GetEquipInfo_bySearchcondition", Searchcondition)
    ...
    Public Shared Function GetEquippkidByControlNO(ByVal ControlNO As String) As Integer
        Dim equippkid As Integer = Convert.ToInt32(SqlHelper.ExecuteScalar(ConfigurationInfo.ConnectionString, "GetEquippkidByControlNO", ControlNO))

        Return equippkid
    End Function

    Public Shared Function GetInfoByParentID(ByVal ParentID As Integer) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "EquipFile_GetInfoByParentID", ParentID)
        Dim dt As DataTable = ds.Tables(0)
    ...
    Public Shared Function GetDeptBySearchcondition(ByVal Searchcondition As String) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "EquipFile_GetDeptBySearchcondition", Searchcondition)
        Dim dt As DataTable = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            Return dt
        Else
    ...
    Public Shared Function GetQyBySearchcondition(ByVal Searchcondition As String) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "EquipFile_GetQyBySearchcondition", Searchcondition)
        Dim dt As DataTable = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            Return dt
        Else
    ...
    Public Shared Function GetEquipBySearchcondition(ByVal Searchcondition As String) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "EquipFile_GetEquipBySearchcondition", Searchcondition)
        Dim dt As DataTable = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            Return dt
        Else
        ...
        End If
    End Function
    Public Shared Function GetInfoByeFlowDocID(ByVal eFlowDocID As String) As EquipFileInfo
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "EquipFile_GetInfoByeFlowDocID", eFlowDocID)
        Dim dt As DataTable = ds.Tables(0)
