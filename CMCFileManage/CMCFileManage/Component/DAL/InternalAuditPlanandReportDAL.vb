...
#Region " Method"
    ...
    Private Function Insert() As Integer
     ...
     InternalAuditPlanandReportInstance.RecordCreated, _
     InternalAuditPlanandReportInstance.RecordDeleted))
        Return (_InternalAuditPlanandReportInstance.PKID)
    End Function
    ...
    End Function
    Public Shared Function GetInelFileBySearchcondition(ByVal Searchcondition As String) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "InternalAuditPlanandReport_GetInfoBySearchCondition", Searchcondition)
        Dim dt As DataTable = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            Return dt
        Else
    ...
    Public Shared Function GetQyBySearchcondition(ByVal Searchcondition As String) As DataTable
        Dim ds As DataSet = SqlHelper.ExecuteDataset(ConfigurationInfo.ConnectionString, "InternalAuditPlanandReport_GetQyBySearchcondition", Searchcondition)
        Dim dt As DataTable = ds.Tables(0)
        If dt.Rows.Count > 0 Then
            Return dt
