<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InternalAuditDetail.aspx.vb"
    Inherits="CMCFileManage.InternalAuditDetail" %>
            ...
            <td>
                ...
                <div>
                    <table border="1" cellspacing="0" cellpadding="0" bordercolor="#000000" bordercolordark="#FFFFFF"
                        ...
                        <tr>
                            <td bgcolor="#E5E5E5">
                                <asp:Label ID="LbdoDate" runat="server" Text="報告日期"></asp:Label>
                            </td>
                            <td>
