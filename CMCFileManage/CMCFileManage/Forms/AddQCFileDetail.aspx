<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" Theme="Default"
    CodeBehind="AddQCFileDetail.aspx.vb" Inherits="CMCFileManage.AddQCFileDetail" %>
...
<body scroll="Auto">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
     ...
     <table width ="100%" ><tr><td> <asp:Image ID="Image4" runat="server" ImageUrl="../Images/blank.jpg" />
    <div align="center">
        ...
        <asp:LinkButton ID="LinkPrint" class="easyui-linkbutton"  runat="server" iconCls="icon-Manage" >紙檔列印</asp:LinkButton>
        &nbsp;<asp:LinkButton ID="LinkEmail" class="easyui-linkbutton" Visible ="false"  runat="server" iconCls="icon-Manage" >郵件通知</asp:LinkButton>
    ...
    <div style="height: 30px">
        <asp:CheckBox ID="ChbSethuiqian" Text ="設定會簽" Visible ="false"  runat="server" />
    </div>
    ...
    <div id="tartx" align="center" style="width: 100%">
        <table width="100%" style="height: 500px" border="1" cellspacing="0" cellpadding="0"
            ...
            <tr>
                <td rowspan="12" style="width: 70px" align="center" height="100%">
                ...
                <td align="left" width="160px">
                    <asp:DropDownList ID="DPLApplyDepth" onchange="deptchange()" runat="server" Width="155px">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox ID="TxtFileName"  style="overflow-y:visible;"  runat="server" Width="90%" TextMode="MultiLine"></asp:TextBox>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:DropDownList ID="DPLFileLayer" Width="155px" onchange="dpllayerchange()" runat="server"
                        AutoPostBack="false">
                        <asp:ListItem Value ="1">QM</asp:ListItem>
                        <asp:ListItem Value ="2">QP</asp:ListItem>
                        <asp:ListItem Value ="3">WI</asp:ListItem>
                        <asp:ListItem Value ="4">QF</asp:ListItem>
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td align="left" colspan="3">
                    <asp:TextBox ID="TxtChangeReason"  style="overflow-y:visible;"  Width ="80%" runat="server" 
            ...
            <tr>
                ...
                <td align="left" colspan="2">
                    <asp:TextBox ID="TxtChangePreDes"  style="overflow-y:visible;"  Width ="80%" runat="server" TextMode="MultiLine"></asp:TextBox>
                ...
                <td align="left" colspan="2">
                    <asp:TextBox ID="TxtChangeBehDes"  style="overflow-y:visible;"  Width ="80%" runat="server" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <td align="left" width="50%" nowrap="true" valign="top">
                                    <asp:CheckBox ID="CHBdept" Style="float: left" onclick="checkchange(this)" Text='<%# DataBinder.Eval(Container.DataItem,"ParameterText") %> '
                                        runat="server" />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#000000"
            ...
            <tr id="fd1">
                ...
                <td align="left">
                    ...
                    <uc1:UcFileDetail ID="UcFileDetail2" Visible ="false"  runat="server" />
                </td>
                <td>
                    品保結案
                </td>
                        ...
                        <asp:Repeater ID="Repeater3" runat="server">
                            <ItemTemplate>
                                <td align="left" width="50%">
                                    <asp:CheckBox ID="CHBdept" Style="float: left" onclick="hscheckchange(this)" Text='<%# DataBinder.Eval(Container.DataItem,"ParameterText") %> '
                                        runat="server" />
                                    <div id="divzdnums" runat="server" style="float: right" class="cssnovisible">
                                        <asp:TextBox ID="TxtzdNums" Width="20px" class="easyui-numberbox" data-options="min:0,max:100,required:true,precision:0"
                                            Text="0" runat="server"></asp:TextBox>
