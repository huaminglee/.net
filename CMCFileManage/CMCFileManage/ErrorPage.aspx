<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ErrorPage.aspx.vb" Inherits="CMCFileManage.ErrorPage" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="margin-top:8px;">
        ...
        <tr>
            <td colspan="2" nowrap>
                <br>
                &nbsp;&nbsp;
                <asp:HyperLink ID="HyperLink1" runat="server" Target="_parent" CssClass="ContentText">回到首頁</asp:HyperLink>&nbsp;&nbsp;
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="ContentText">回前一頁</asp:HyperLink>
                <br />
                <br />
                應用和系統整合實驗室 李金坪 61675</td>
        </tr>
    </table>
    </div>
    </form>
