    ...
    <table width="681" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 120px">
                ...
                <table width="190" height="106" border="0" align="center" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Button ID="Button1" width="69px" Style="background: url(Newstyle/login_5.gif) no-repeat"
                                runat="server" Text="登陸" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td colspan="3" align="center"  >
                &nbsp;
                品質管理系統密碼和測試申請系統一致，如不能登陸請聯繫應用系統整合 李金坪 560-61675</td>
        </tr>
    </table>
    </form>
</body>
