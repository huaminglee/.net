            ...
            <div>
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <div>
                                <div class="LiAdd" style="width: 150px; float: left;">
                                    <a class="LiAdd" id="A1" href="javascript:Addnew()" 
                                        runat="server"><span>新增單選項目 </a>
                                </div>
                                 <div class="LiAdd" style="width: 70px; float: left;">
                                    <a class="LiAdd" id="A2" href="javascript:Addmulnew()"  
                                        runat="server"><span>新增多選項目 </a>
                                </div>
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="LbItemCategory" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ItemCategory") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
