    ...
    <fieldset>
        ...
        <select id="target">
            <option selected="selected" value="">
                <%=ResourceManager.GetString("openlinktype")%></option>
            <option value="_blank">
                <%=ResourceManager.GetString("_blank")%></option>
            <option value="_self">
                <%=ResourceManager.GetString("_self")%></option>
            <option value="_parent">
                <%=ResourceManager.GetString("_parent")%></option>
            <option value="_top">
                <%=ResourceManager.GetString("_top")%></option>
        </select><br />
        <input id="insert" onclick="insertLink();" type="button" value='<%=ResourceManager.GetString("insert")%>' />
