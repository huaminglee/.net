...
Public Class DownLoadZip
    ...
    Private _FileID As String() = Nothing
...
#Region "public  function"
    Public Function CreatZIP() As Boolean
        ...
        For index = 0 To FileID.Length - 1
            Dim mFIleInfo As WF_AttachFileInfoInfo = WF_AttachFileInfoDAL.GetInfoByPKID(FileID(index))
            If mFIleInfo IsNot Nothing Then
                If mFIleInfo.FileContent IsNot Nothing AndAlso mFIleInfo.FileContent.Length > 0 Then
                    Dim abyBuffer As Byte() = mFIleInfo.FileContent
                    Dim objZipEntry As ZipEntry = New ZipEntry(mFIleInfo.FileName)
