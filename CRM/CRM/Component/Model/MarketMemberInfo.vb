...
''' <remarks></remarks>
<Serializable()> _
Partial Public Class MarketMemberInfo
#Region " Private Fields "
    Private m_iPKID As Integer = 0
    Private m_strType As String = String.Empty
    Private m_iPlanPKID As Integer = 0
    Private m_strMemberCategory As String = String.Empty
...
#Region " Public Properties"
		...
		''' 市場計劃PKID
		''' </summary>
		public Property PlanPKID as Integer 
		Get
			return m_iPlanPKID 
		End Get
		Set(ByVal Value As Integer)
		...
		Get
			 return m_strMemberCategory 
		End Get
		Set(ByVal Value As string)
			 m_strMemberCategory = value
		End Set
		End Property
		''' <summary>
		''' 聯繫人姓名
