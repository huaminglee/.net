...
Partial Public Class SampelReceivedList
...
#Region "屬性"
    ...
    Private ReadOnly Property InitSearch() As String
        Get
            ...
            Else
                Dim SearchCondition As String = " RecordDeleted!=1 "
                If UserInfo.IsInRoles("storekeeper") OrElse UserInfo.IsInRoles("CRMTECSUPPORT") Then

                ElseIf UserInfo.IsInRoles("EXTERNALWORKER") Then
                    SearchCondition += " and Extend01='" + UserInfo.CurrentUserID.ToString + "'"

                End If
                If CurType = 0 Then
                    SearchCondition += " and IsTakeaway=0"
                ElseIf CurType = 1 Then
                    SearchCondition += " and IsTakeaway=1"
...
#End Region
    ...
    Private Sub BindGrid(ByVal SearchCondition As String)
        ...
        Dim ds As DataSet = GridViewPage.GetPageInfoBySearchCondition("SamplesReceived", SearchCondition, "*", SortField + " " + SortOrder, PageSize, PageIndex, TotalRecord)
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If e.Row.RowState = DataControlRowState.Normal OrElse e.Row.RowState = DataControlRowState.Alternate Then
                ...
                Dim ReturnURL As String = "../Quotation/AddSampleReceived.aspx?" & Global_asax.QUERY_APPLICANTIDX & "=" + mPKID.ToString
    ...
    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        ...
        SamplesReceivedDAL.Delete(mpkid)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        If Me.TxtSearchCondition.Text <> String.Empty Then
            NewSearchCondition += String.Format(" and (CustomerName like N'%{0}%' or SampleName like N'%{0}%' or InformUser like N'%{0}%')", Me.TxtSearchCondition.Text.Trim.ToString)
        End If
