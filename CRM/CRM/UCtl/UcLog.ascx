<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UcLog.ascx.vb" Inherits="CRM.UcLog" %>
...
<div>
    <table>
        <tr>
            ...
            <td>
                <asp:LinkButton ID="LinkSearch" Visible="true" class="easyui-linkbutton" plain="true"
                    iconCls="icon-search" runat="server">查詢</asp:LinkButton>
            </td>
            <td>
