<%@ Page Language="vb" AutoEventWireup="false" Theme ="Default"  CodeBehind="SysNewsList.aspx.vb" Inherits="CRM.SysNewsList" %>
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HLDetail" runat="server" ToolTip ="查看" ImageUrl="../Images/ico/pen.png" Target="_self"></asp:HyperLink>
                            </ItemTemplate>
                            <HeaderTemplate>
                        ...
                        <asp:TemplateField HeaderText="刪除" Visible ="false">
                            <ItemTemplate>
                                <asp:ImageButton ID="BtnDelete" runat="server" ImageUrl="~/Images/DeleteFile.gif"
