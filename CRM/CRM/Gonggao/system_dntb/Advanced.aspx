...
<body leftmargin="5" topmargin="5">
    ...
    <table border="1" cellpadding="0" cellspacing="0" width="95%">
        ...
        <tr>
            <td style="height: 20px; width: 90%;">
                ...
                <asp:RangeValidator ID="RangeValidator1" runat="server" BackColor="White" BorderColor="Red"
                    BorderWidth="1px" ControlToValidate="maxAllUploadSize" MaximumValue="99999999999999"
                    ErrorMessage="必须是整数,而且最小0" MinimumValue="0" Type="Double"></asp:RangeValidator>
            </td>
            <td style="height: 20px; text-align: right;">
                <asp:Button ID="Button3" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
        ...
        <tr>
            <td style="height: 25px; width: 90%;">
                ...
                <asp:RangeValidator ID="RangeValidator2" runat="server" BackColor="White" BorderColor="Red"
                    BorderWidth="1px" ControlToValidate="maxSingleUploadSize" MaximumValue="99999999999999"
                    ErrorMessage="必须是整数,而且最小0" MinimumValue="0" Type="Double"></asp:RangeValidator>
            </td>
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button1" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button4" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button4_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button5" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button6" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button7" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button7_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button8" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button8_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button9" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button9_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button10" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button10_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button11" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button11_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
                设置图片水印所在的位置(自动存为logo.gif)
            </td>
        </tr>
        <tr>
            <td style="height: 25px; width: 90%;">
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button12" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button12_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button13" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button13_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button14" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button14_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button15" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button15_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button16" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button16_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button17" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button17_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button18" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button18_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button19" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button19_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button20" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button20_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button21" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button21_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button22" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button22_Click" />
            </td>
        </tr>
        <tr>
            <td style="height: 25px" colspan="2">
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right;">
                <asp:Button ID="Button23" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button23_Click" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="height: 25px; text-align: right">
                <asp:Button ID="Button24" runat="server" Text="更新" Width="112px" BorderColor="#E0E0E0"
                    Height="24px" OnClick="Button24_Click" />
            </td>
        </tr>
    </table>
    </form>
