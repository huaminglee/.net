...
#Region "private Methods"
    ...
    Private Sub BindControlData()
        ...
        If NewsID = String.Empty Then
            ...
            Me.DDLServiceName.Items.Insert(0, New ListItem("CRM", 0))
        ...
        Else
            If Not UserInfo.CurrentUserInstance Is Nothing Then
                ...
                If UserInfo.IsInRoles("SYS_ADMINISTRATOR") OrElse UserInfo.IsInRoles("ZHONGXINZHUGUAN") OrElse UserInfo.IsInRoles("Yewuzhuguan") OrElse UserInfo.IsInRoles("TEDINGSHENHE") Then
