...
function CheckChanged() {
   ...
   // $('.chkselect').attr("checked", !(IsCheck));
...
function SelectRow(oCheckBox) {
    ...
    if (oCheckBox.checked) {
        oTR.style.cssText = "background-color: #919191"
...
function DialogMove(left, top, dialogID) {
    ...
    if (top < 0) {
        ...
        $(dialogID).dialog("move", { left: left, top: bottom });
    }
...
function SelectSingleCheckBoxClick(e) {
    SelectRow(e.srcElement); 
}