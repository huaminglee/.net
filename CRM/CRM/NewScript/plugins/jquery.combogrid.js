...
_5.keyup(function(e) {
    switch (e.keyCode) {
        case 17:
            _3.keyHandler.CtrlUp.call(_2);
            break;
        default:
    }
});
_5.keydown(function(e) {
    switch (e.keyCode) {
        case 17:
            _3.keyHandler.CtrlDown.call(_2);
            break;
        default:
    }
});
if (_3.multiple)
{ _5[0].title = _3.toolTip; }
if(!_4){
...
//wqy
if (_3.multiple) {
    _3.onlySelectOne = !_3.multiple;
    _3.multiple = false;
}
//wqy singleSelect: (!opts.multiple), onlySelectOne: (opts.onlySelectOne)
