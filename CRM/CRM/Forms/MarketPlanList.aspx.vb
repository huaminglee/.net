...
Partial Public Class MarketPlanList
...
#Region "屬性"
    ...
    Private ReadOnly Property InitSearch() As String
        Get
            ...
            Else
                Dim SearchCondition As String = " RecordDeleted=0 and Owner='" + UserInfo.CurrentUserCHName + "'"
...
#End Region
    ...
    Private Sub BindGrid(ByVal SearchCondition As String)
        ...
        Dim ds As DataSet = GridViewPage.GetPageInfoBySearchCondition("MarketingPlan", SearchCondition, "*", SortField + " " + SortOrder, PageSize, PageIndex, TotalRecord)
    ...
    Protected Sub BtnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles BtnSearch.Click
        ...
        If Me.TxtSearchCondition.Text <> String.Empty Then
            NewSearchCondition += String.Format(" and (MarkPlanName like '%{0}%' or Type like '%{0}%')", Me.TxtSearchCondition.Text.Trim.ToString)
        End If
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            HLDetail.NavigateUrl = "../Forms/MarketPlanDetail.aspx?pkid=" + mpkid.ToString
        End If
    End Sub

    Protected Sub GridView1_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles GridView1.RowDeleting
        Dim mpkid As Integer = CInt(Me.GridView1.DataKeys(e.RowIndex).Value)
        MarketingPlanDAL.Delete(mpkid)
    End Sub
End Class