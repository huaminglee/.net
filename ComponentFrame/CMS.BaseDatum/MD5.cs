...
namespace PengeSoft.CMS.BaseDatum
{
    ...
    public class MD5
    {
        ...
        /// 对一段二进制数据进行MD5加密
        /// </summary>
        /// <param name="array">要进行MD5处理的二进制数据</param>
        /// <param name="uppercase">大小写格式，若设为true则为大写，否则为小写。</param>
        ...
        /// 对字符串进行MD5加密
        /// </summary>
        /// <param name="message">要进行MD5处理的字符串</param>
        /// <returns>加密后的MD5字符串</returns>
        ...
        /// 对一个文件进行MD5加密
        /// </summary>
        /// <param name="fileName">要进行MD5处理的文件名</param>
        /// <returns>加密后的MD5字符串</returns>
